  ...
  return (
    <svg viewBox="0 0 680 920" role="img" className={className}>
      ...
      <g fontFamily="sans-serif" fontSize="14" fill={INK}>
        <StationLink href="oncheonjang.html">
        ...
        <StationLink href="seomyeon.html">
        ...
        <StationLink href="busan-station.html">
